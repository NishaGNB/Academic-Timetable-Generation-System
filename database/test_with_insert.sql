-- Test with INSERT statement into Timetable table
...
AS
    ...
    v_fac_id NUMBER := 1; -- Test value
    v_room_no VARCHAR2(20) := 'LH-101'; -- Test value
...
BEGIN
    ...
    FOR rec_class IN c_classes LOOP
        ...
        FOR rec_course IN c_courses(rec_class.class_id) LOOP
            ...
            -- Test DECLARE block with slot cursor and INSERT
            DECLARE
    ...
    VALUES ('Test message with INSERT. Classes: ' || v_total_classes || ', Courses: ' || v_total_courses, 'INFO', v_process_id);
